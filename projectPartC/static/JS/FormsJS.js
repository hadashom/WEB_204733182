...
//         // nextPageFun(currentPathWithoutPageName + "/SignUp");
//     })
// }
...
//         console.log("Hi")
//         // nextPageFun(currentPathWithoutPageName + "/SignIn");
//     })
// }
...
//             alert("You Can Enter")
//             nextPageFun(currentPathWithoutPageName + ("/StartQuestions"));
//         }
//         else {
...
function confirm_logout() {
    ...
    if (res == true) {
      window.location.replace("http://localhost:3000/removeEmailCookie");
    } else {
      return;
    }
  }
